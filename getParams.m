...
q1 = angle2quat(pi/9, 0, pi/4, 'ZYX')';
q1 = q1(2:end);
x1 = [10; 5; 0; 0; 0; 0; q1; 0; 0; 0];
u1 = [0; 0; m*g; 0];

q2 = angle2quat(0, 0, 0, 'ZYX')';
q2 = q2(2:end);
x2 = [5; 2.5; 0; 0; 0; 0; q2; 0; 0; 0];
u2 = [0; 0; m*g; 0];
...
[x_set, u_set, t_set_unfiltered, Kset, tSegs] = get_trajectory(10000, 10, [x1, x2, x3], [u1, u2, u3], [m; l; g], MOI);
